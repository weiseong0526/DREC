/* Prince Paw — chrome partials (header, footer, drawer, scrim).
   Call PPChrome.mount({ active: "home" | "shop" | "about" | "quiz" | "admin" }) early in <body>.
*/
(function () {
    ...
    <header class="pp-header">
      <div class="pp-header__inner">
        ...
        <div class="pp-header__actions">
          ...
          <a href="orders.html" class="pp-iconbtn" aria-label="Track your parcel" style="position:relative;text-decoration:none;">
            <i data-lucide="package"></i>
            <span class="pp-chat-notif" style="display:none;position:absolute;top:-3px;right:-3px;background:#e53935;color:white;font-size:10px;font-weight:700;min-width:18px;height:18px;border-radius:999px;align-items:center;justify-content:center;border:2px solid white;padding:0 3px;"></span>
          </a>
  ...
  window.PPChrome = {
    mount({ active } = {}) {
      ...
      if (!document.getElementById("pp-chat-script")) {
        const s = document.createElement("script");
        s.id = "pp-chat-script";
        s.src = "scripts/chat.js";
